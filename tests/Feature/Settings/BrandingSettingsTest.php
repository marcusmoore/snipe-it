...
test('site name can be saved', function () {
    $response = $this->actingAs(User::factory()->superuser()->create())
...
test('logo can be uploaded', function () {
    Storage::fake('public');
...
test('logo can be deleted', function () {
    Storage::fake('public');
...
test('email logo can be uploaded', function () {
    Storage::fake('public');
...
test('email logo can be deleted', function () {
    Storage::fake('public');
    ...
    expect($setting->email_logo)->not->toBeNull();
...
test('label logo can be uploaded', function () {
    Storage::fake('public');
...
test('label logo can be deleted', function () {
    Storage::fake('public');
    ...
    expect($setting->label_logo)->not->toBeNull();
...
test('default avatar can be uploaded', function () {
    Storage::fake('public');
...
test('default avatar can be deleted', function () {
    Storage::fake('public');
    ...
    expect($setting->default_avatar)->not->toBeNull();
...
test('snipe default avatar can be deleted', function () {
    ...
    expect($setting->refresh()->default_avatar)->toBeNull();
    $this->assertDatabaseHas('settings', ['default_avatar' => null]);
    Storage::disk('public')->assertExists('avatars/default.png');
});

test('favicon can be uploaded', function () {
...
test('favicon can be deleted', function () {
    $this->markTestIncomplete('This fails mimetype validation on the mock');
    Storage::fake('public');
