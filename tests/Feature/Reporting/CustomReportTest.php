...
test('can load custom report page', function () {
...
test('saved templates on page are scoped to the user', function () {
...
test('custom asset report', function () {
...
test('custom asset report adheres to company scoping', function () {
...
test('can limit assets by last check in', function () {
