...
test('that a non existent asset id returns error', function () {
...
test('updates u s decimal for purchase cost', function () {
    $this->settings->set([
        'default_currency' => 'EUR',
        'digit_separator' => '1,234.56',
    ]);
...
test('updates float u s decimal for purchase cost', function () {
    $this->settings->set([
        'default_currency' => 'EUR',
        'digit_separator' => '1,234.56',
    ]);
